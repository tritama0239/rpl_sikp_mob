...
import 'package:flutter_sikp/Koor/SuratKeterangan/ajukansuratket.dart';
import 'package:flutter_sikp/Koor/SuratKeterangan/detailsuratket.dart';
...
class _DbSuratKetState extends State<DbSuratKet> {
  Future<List> getData() async{
    final response= await http.get("http://10.0.2.2/crud/getkoorsk.php");
