...
import 'package:flutter_sikp/Koor/Kp/ajukankp.dart';
import 'package:flutter_sikp/Koor/Kp/detailkp.dart';
...
class _DbKpState extends State<DbKp> {
  Future<List> getData() async{
    final response= await http.get("http://10.0.2.2/crud/getkoorkp.php");
