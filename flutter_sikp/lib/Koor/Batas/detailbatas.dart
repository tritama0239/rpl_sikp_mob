...
class DetailBatas extends StatefulWidget {
  List list;
  int index;
  DetailBatas({this.list, this.index});

  @override
  _DetailBatasState createState() => _DetailBatasState();
}

class _DetailBatasState extends State<DetailBatas> {
  @override
          ...
          child: new Center(
            child: new Column(
              children: <Widget>[
                  ...
                  new Text("Batas Pelaksanaan : ${widget.list[widget.index]['bts_pelaksanaan']}", style: new TextStyle(fontSize: 18.0),),
                  new Padding(padding: const EdgeInsets.only(top: 30.0),),
                  new Row(
